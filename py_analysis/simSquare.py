...
for acount in range(10):
    ...
    outfile = "potential" + '{0:02d}'.format(acount) +".npy"
...
#plt.plot(xGrid[1:64],pot)
#figure
#plt.plot(xGrid[1:64],downs[1:64],xGrid[1:64], thGriddown[1:64])
#plt.plot(xGrid[1:64],ups[1:64],xGrid[1:64], thGridup[1:64])
